...
/// 用于存储图书的分类信息
abstract class BookCategory implements _i1.TableRow, _i1.ProtocolSerialization {
  BookCategory._({
    this.id,
    required this.name,
    this.description,
...
class BookCategoryTable extends _i1.Table {
...
class BookCategoryInclude extends _i1.IncludeObject {
  ...
  @override
  _i1.Table get table => BookCategory.t;
}
