...
SELECT pg_catalog.setval('public.serverpod_health_connection_info_id_seq', 209, true);
...
SELECT pg_catalog.setval('public.serverpod_health_metric_id_seq', 212, true);
...
SELECT pg_catalog.setval('public.serverpod_readwrite_test_id_seq', 212, true);
