...
SELECT pg_catalog.setval('public.serverpod_health_connection_info_id_seq', 178, true);
...
SELECT pg_catalog.setval('public.serverpod_health_metric_id_seq', 181, true);
...
SELECT pg_catalog.setval('public.serverpod_readwrite_test_id_seq', 181, true);
