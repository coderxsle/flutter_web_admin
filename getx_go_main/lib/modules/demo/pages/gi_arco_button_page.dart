...
class GiArcoButtonDemoPage extends StatelessWidget {
  final String title;
  const GiArcoButtonDemoPage({super.key, required this.title});
          ...
          Expanded(
            child: SingleChildScrollView(
              child: ConstrainedBox(
                constraints: BoxConstraints(minHeight: MediaQuery.of(context).size.height - 180, minWidth: MediaQuery.of(context).size.width),
                child: Card(
                  child: Padding(
