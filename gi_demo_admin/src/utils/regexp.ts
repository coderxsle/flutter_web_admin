...
/**
 * 英文与下划线正则
 * @description 匹配英文字符和下划线，支持 common_status 形式
 * @example
 * OnlyEnUnderline.test('common_status') // true
 * OnlyEnUnderline.test('status') // true
 * OnlyEnUnderline.test('status_1') // false
 */
export const OnlyEnUnderline = /^[a-z]+(_[a-z]+)*$/i
