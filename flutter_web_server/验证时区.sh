...
docker exec development-postgres-1 psql -U postgres -d flutter_web_admin -c "SHOW timezone;"

echo ""
echo "2. 检查当前时间："
docker exec development-postgres-1 psql -U postgres -d flutter_web_admin -c "SELECT now();"
