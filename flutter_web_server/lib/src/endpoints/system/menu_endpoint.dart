...
class MenuEndpoint extends Endpoint {
  ...
  /// [parentId] 父菜单ID
  /// 返回值：菜单树列表
  List<Map<String, dynamic>> _buildMenuTree(List<SysMenu> menus, {int parentId = 0}) {
  ...
  /// [menus] 菜单列表
  /// 返回值：菜单树列表
  List<Map<String, dynamic>> _buildMenuListTree(List<SysMenu> menus) {
  ...
  /// 排序菜单树
  /// 
  void _sortMenuTree(List<Map<String, dynamic>> nodes) {
    nodes.sort((a, b) {
