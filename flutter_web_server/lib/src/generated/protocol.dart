...
import 'book/book.dart' as _i12;
import 'book/book_category.dart' as _i13;
import 'book/book_inventory_log.dart' as _i14;
import 'book/book_package.dart' as _i15;
import 'book/book_package_item.dart' as _i16;
import 'book/book_sale.dart' as _i17;
import 'common/pagination.dart' as _i18;
...
import 'system/infra_api_access_log.dart' as _i26;
import 'system/infra_api_error_log.dart' as _i27;
import 'system/infra_file.dart' as _i28;
import 'system/infra_file_config.dart' as _i29;
import 'system/infra_file_content.dart' as _i30;
import 'system/infra_job.dart' as _i31;
import 'system/infra_job_log.dart' as _i32;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i12.Book) {
      return _i12.Book.fromJson(data) as T;
    }
    if (t == _i13.BookCategory) {
      return _i13.BookCategory.fromJson(data) as T;
    }
    if (t == _i14.BookInventoryLog) {
      return _i14.BookInventoryLog.fromJson(data) as T;
    }
    if (t == _i15.BookPackage) {
      return _i15.BookPackage.fromJson(data) as T;
    }
    if (t == _i16.BookPackageItem) {
      return _i16.BookPackageItem.fromJson(data) as T;
    }
    if (t == _i17.BookSale) {
      return _i17.BookSale.fromJson(data) as T;
    }
    ...
    if (t == _i26.InfraApiAccessLog) {
      return _i26.InfraApiAccessLog.fromJson(data) as T;
    }
    if (t == _i27.InfraApiErrorLog) {
      return _i27.InfraApiErrorLog.fromJson(data) as T;
    }
    if (t == _i28.InfraFile) {
      return _i28.InfraFile.fromJson(data) as T;
    }
    if (t == _i29.InfraFileConfig) {
      return _i29.InfraFileConfig.fromJson(data) as T;
    }
    if (t == _i30.InfraFileContent) {
      return _i30.InfraFileContent.fromJson(data) as T;
    }
    if (t == _i31.InfraJob) {
      return _i31.InfraJob.fromJson(data) as T;
    }
    if (t == _i32.InfraJobLog) {
      return _i32.InfraJobLog.fromJson(data) as T;
    }
    if (t == _i33.SysDept) {
    ...
    if (t == _i1.getType<_i12.Book?>()) {
      return (data != null ? _i12.Book.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i13.BookCategory?>()) {
      return (data != null ? _i13.BookCategory.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i14.BookInventoryLog?>()) {
      return (data != null ? _i14.BookInventoryLog.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i15.BookPackage?>()) {
      return (data != null ? _i15.BookPackage.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i16.BookPackageItem?>()) {
      return (data != null ? _i16.BookPackageItem.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i17.BookSale?>()) {
      return (data != null ? _i17.BookSale.fromJson(data) : null) as T;
    }
    ...
    if (t == _i1.getType<_i26.InfraApiAccessLog?>()) {
      return (data != null ? _i26.InfraApiAccessLog.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i27.InfraApiErrorLog?>()) {
      return (data != null ? _i27.InfraApiErrorLog.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i28.InfraFile?>()) {
      return (data != null ? _i28.InfraFile.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i29.InfraFileConfig?>()) {
      return (data != null ? _i29.InfraFileConfig.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i30.InfraFileContent?>()) {
      return (data != null ? _i30.InfraFileContent.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i31.InfraJob?>()) {
      return (data != null ? _i31.InfraJob.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i32.InfraJobLog?>()) {
      return (data != null ? _i32.InfraJobLog.fromJson(data) : null) as T;
    }
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i12.Book => 'Book',
      _i13.BookCategory => 'BookCategory',
      _i14.BookInventoryLog => 'BookInventoryLog',
      _i15.BookPackage => 'BookPackage',
      _i16.BookPackageItem => 'BookPackageItem',
      _i17.BookSale => 'BookSale',
      _i18.Pagination => 'Pagination',
      _i19.Customer => 'Customer',
      _i20.Region => 'Region',
      _i21.Store => 'Store',
      _i22.StoreActivity => 'StoreActivity',
      _i23.StoreActivityBook => 'StoreActivityBook',
      _i24.StoreBook => 'StoreBook',
      _i25.StoreSalesRecord => 'StoreSalesRecord',
      _i26.InfraApiAccessLog => 'InfraApiAccessLog',
      _i27.InfraApiErrorLog => 'InfraApiErrorLog',
      _i28.InfraFile => 'InfraFile',
      _i29.InfraFileConfig => 'InfraFileConfig',
      _i30.InfraFileContent => 'InfraFileContent',
      _i31.InfraJob => 'InfraJob',
      _i32.InfraJobLog => 'InfraJobLog',
  ...
  String? getClassNameForObject(Object? data) {
    ...
    switch (data) {
      ...
      case _i12.Book():
        return 'Book';
      case _i13.BookCategory():
        return 'BookCategory';
      case _i14.BookInventoryLog():
        return 'BookInventoryLog';
      case _i15.BookPackage():
        return 'BookPackage';
      case _i16.BookPackageItem():
      ...
      case _i26.InfraApiAccessLog():
        return 'InfraApiAccessLog';
      case _i27.InfraApiErrorLog():
        return 'InfraApiErrorLog';
      case _i28.InfraFile():
        return 'InfraFile';
      case _i29.InfraFileConfig():
        return 'InfraFileConfig';
      case _i30.InfraFileContent():
        return 'InfraFileContent';
      case _i31.InfraJob():
        return 'InfraJob';
      case _i32.InfraJobLog():
        return 'InfraJobLog';
      case _i33.SysDept():
        return 'SysDept';
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'Book') {
      return deserialize<_i12.Book>(data['data']);
    }
    if (dataClassName == 'BookCategory') {
      return deserialize<_i13.BookCategory>(data['data']);
    }
    if (dataClassName == 'BookInventoryLog') {
      return deserialize<_i14.BookInventoryLog>(data['data']);
    }
    if (dataClassName == 'BookPackage') {
      return deserialize<_i15.BookPackage>(data['data']);
    }
    if (dataClassName == 'BookPackageItem') {
      return deserialize<_i16.BookPackageItem>(data['data']);
    }
    if (dataClassName == 'BookSale') {
      return deserialize<_i17.BookSale>(data['data']);
    }
    ...
    if (dataClassName == 'InfraApiAccessLog') {
      return deserialize<_i26.InfraApiAccessLog>(data['data']);
    }
    if (dataClassName == 'InfraApiErrorLog') {
      return deserialize<_i27.InfraApiErrorLog>(data['data']);
    }
    if (dataClassName == 'InfraFile') {
      return deserialize<_i28.InfraFile>(data['data']);
    }
    if (dataClassName == 'InfraFileConfig') {
      return deserialize<_i29.InfraFileConfig>(data['data']);
    }
    if (dataClassName == 'InfraFileContent') {
      return deserialize<_i30.InfraFileContent>(data['data']);
    }
    if (dataClassName == 'InfraJob') {
      return deserialize<_i31.InfraJob>(data['data']);
    }
    if (dataClassName == 'InfraJobLog') {
      return deserialize<_i32.InfraJobLog>(data['data']);
    }
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    switch (t) {
      ...
      case _i12.Book:
        return _i12.Book.t;
      case _i13.BookCategory:
        return _i13.BookCategory.t;
      case _i14.BookInventoryLog:
        return _i14.BookInventoryLog.t;
      case _i15.BookPackage:
        return _i15.BookPackage.t;
      case _i16.BookPackageItem:
        return _i16.BookPackageItem.t;
      case _i17.BookSale:
        return _i17.BookSale.t;
      case _i19.Customer:
      ...
      case _i26.InfraApiAccessLog:
        return _i26.InfraApiAccessLog.t;
      case _i27.InfraApiErrorLog:
        return _i27.InfraApiErrorLog.t;
      case _i28.InfraFile:
        return _i28.InfraFile.t;
      case _i29.InfraFileConfig:
        return _i29.InfraFileConfig.t;
      case _i30.InfraFileContent:
        return _i30.InfraFileContent.t;
      case _i31.InfraJob:
        return _i31.InfraJob.t;
      case _i32.InfraJobLog:
        return _i32.InfraJobLog.t;
      case _i33.SysDept:
        return _i33.SysDept.t;
      case _i34.SysDictData:
        return _i34.SysDictData.t;
      case _i35.SysDictType:
        return _i35.SysDictType.t;
      case _i36.SysLoginLog:
        return _i36.SysLoginLog.t;
      case _i37.SysMailAccount:
        return _i37.SysMailAccount.t;
      case _i38.SysMailLog:
        return _i38.SysMailLog.t;
      case _i39.SysMailTemplate:
        return _i39.SysMailTemplate.t;
      case _i40.SysMenu:
        return _i40.SysMenu.t;
      case _i41.SysNotice:
        return _i41.SysNotice.t;
      case _i42.SysNotifyMessage:
        return _i42.SysNotifyMessage.t;
      case _i43.SysNotifyTemplate:
        return _i43.SysNotifyTemplate.t;
      case _i44.SysOperateLog:
        return _i44.SysOperateLog.t;
      case _i45.SysPost:
        return _i45.SysPost.t;
      case _i46.SysRole:
        return _i46.SysRole.t;
      case _i47.SysRoleMenu:
        return _i47.SysRoleMenu.t;
      case _i48.SysSmsChannel:
        return _i48.SysSmsChannel.t;
      case _i49.SysSmsCode:
        return _i49.SysSmsCode.t;
      case _i50.SysSmsLog:
        return _i50.SysSmsLog.t;
      case _i51.SysSmsTemplate:
        return _i51.SysSmsTemplate.t;
      case _i52.SysSocialClient:
        return _i52.SysSocialClient.t;
      case _i53.SysSocialUser:
        return _i53.SysSocialUser.t;
      case _i54.SysSocialUserBind:
        return _i54.SysSocialUserBind.t;
      case _i55.SysTenant:
        return _i55.SysTenant.t;
      case _i56.SysTenantPackage:
        return _i56.SysTenantPackage.t;
      case _i57.SysUser:
        return _i57.SysUser.t;
      case _i58.SysUserPost:
        return _i58.SysUserPost.t;
      case _i59.SysUserRole:
        return _i59.SysUserRole.t;
      case _i60.Qimen:
        return _i60.Qimen.t;
    }
    return null;
