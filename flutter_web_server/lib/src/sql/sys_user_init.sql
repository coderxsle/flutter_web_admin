...
VALUES
  -- 总部 / 管理层
  (0, '019ca2b5-2fcc-719a-8fb6-4e8baed3ad9b'::uuid, 1,   '[1]',      'admin',    'pbkdf2_sha256$100000$lOaV2jHTxGKnYTh920XWyQ==$Zxvp027jrR3LcFHBSkeLDUemN1Ys0g0XHxNmQ0HKmSc=',    '系统管理员', '13800000001', 1, 'admin@xinghebooks.com', NULL, '系统内置管理员账号', 1, true,  false, '127.0.0.1',    '2026-02-28 09:20:00', 'system', '2026-02-28 09:20:00', 'system', '2026-01-01 08:00:00'),
  (0, '019d1000-0001-7000-8000-000000000001'::uuid, 2,   '[1,2]',    'chen.yu',  'pbkdf2_sha256$100000$lOaV2jHTxGKnYTh920XWyQ==$Zxvp027jrR3LcFHBSkeLDUemN1Ys0g0XHxNmQ0HKmSc=',     '陈宇',       '13917001201', 1, 'chen.yu@xinghebooks.com', NULL, '总裁办主任，负责战略协同', 1, false, false, '10.20.1.11',  '2026-03-01 08:36:12', 'admin',  '2026-03-01 08:36:12', 'admin',  '2026-01-03 09:10:00'),
  (0, '019d1000-0002-7000-8000-000000000002'::uuid, 3,   '[2,3]',    'zhao.min', 'pbkdf2_sha256$100000$lOaV2jHTxGKnYTh920XWyQ==$Zxvp027jrR3LcFHBSkeLDUemN1Ys0g0XHxNmQ0HKmSc=',     '赵敏',       '13681802345', 2, 'zhao.min@xinghebooks.com', NULL, '人力资源BP负责人', 1, false, false, '10.20.1.12',  '2026-03-01 09:05:18', 'chen.yu','2026-03-01 09:05:18', 'admin',  '2026-01-05 10:00:00'),

  -- 财务 / 供应链
  (0, '019d1000-0003-7000-8000-000000000003'::uuid, 41,  '[4]',      'liu.jie',  'pbkdf2_sha256$100000$lOaV2jHTxGKnYTh920XWyQ==$Zxvp027jrR3LcFHBSkeLDUemN1Ys0g0XHxNmQ0HKmSc=',      '刘杰',       '13761234567', 1, 'liu.jie@xinghebooks.com', NULL, '核算经理，负责总账与结算', 1, false, false, '10.20.2.21',  '2026-03-01 09:22:30', 'chen.yu','2026-03-01 09:22:30', 'admin',  '2026-01-08 11:20:00'),
  (0, '019d1000-0004-7000-8000-000000000004'::uuid, 6,   '[5,6]',    'wang.kai', 'pbkdf2_sha256$100000$lOaV2jHTxGKnYTh920XWyQ==$Zxvp027jrR3LcFHBSkeLDUemN1Ys0g0XHxNmQ0HKmSc=',       '王凯',       '13817770086', 1, 'wang.kai@xinghebooks.com', NULL, '供应链计划经理', 1, false, false, '10.20.2.22',  '2026-03-01 10:12:41', 'chen.yu','2026-03-01 10:12:41', 'admin',  '2026-01-09 14:00:00'),

  -- IT 中心
  (0, '019d1000-0005-7000-8000-000000000005'::uuid, 71,  '[7,8]',    'xu.qiang', 'pbkdf2_sha256$100000$lOaV2jHTxGKnYTh920XWyQ==$Zxvp027jrR3LcFHBSkeLDUemN1Ys0g0XHxNmQ0HKmSc=',     '徐强',       '13918881234', 1, 'xu.qiang@xinghebooks.com', NULL, '后端技术负责人（Serverpod）', 1, false, false, '10.20.3.31',  '2026-03-01 10:45:05', 'admin',  '2026-03-01 10:45:05', 'admin',  '2026-01-11 09:30:00'),
  (0, '019d1000-0006-7000-8000-000000000006'::uuid, 72,  '[8,9]',    'he.ting',  'pbkdf2_sha256$100000$lOaV2jHTxGKnYTh920XWyQ==$Zxvp027jrR3LcFHBSkeLDUemN1Ys0g0XHxNmQ0HKmSc=',      '何婷',       '13524561238', 2, 'he.ting@xinghebooks.com', NULL, '数据分析负责人，维护 BI 看板', 1, false, false, '10.20.3.32',  '2026-03-01 11:01:44', 'xu.qiang','2026-03-01 11:01:44', 'admin',  '2026-01-12 13:40:00'),
  (0, '019d1000-0007-7000-8000-000000000007'::uuid, 73,  '[9]',      'sun.yao',  'pbkdf2_sha256$100000$lOaV2jHTxGKnYTh920XWyQ==$Zxvp027jrR3LcFHBSkeLDUemN1Ys0g0XHxNmQ0HKmSc=',      '孙尧',       '13701775566', 1, 'sun.yao@xinghebooks.com', NULL, '基础设施工程师，负责容器与监控', 1, false, false, '10.20.3.33',  '2026-03-01 11:20:09', 'xu.qiang','2026-03-01 11:20:09', 'admin',  '2026-01-13 10:10:00'),
