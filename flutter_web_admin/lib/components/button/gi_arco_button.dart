...
class GiArcoButton extends StatefulWidget {
  ...
  final GiArcoButtonSize size;        // 按钮尺寸
  ...
  const GiArcoButton({
    ...
    this.size = GiArcoButtonSize.small,
    this.text,
    this.icon,
    this.disabled = false,
    this.onPressed,
...
class _GiArcoButtonState extends State<GiArcoButton>
  ...
  double _getButtonHeight() {
    switch (widget.size) {
      case GiArcoButtonSize.mini:
        return 24.0;
      case GiArcoButtonSize.small:
        return 32.0;
      case GiArcoButtonSize.large:
        return 40.0;
    }
  }
...
class ButtonConfigs {
  ...
  static const Color blackText = Color(0xFF1D2129);
